...
<body> <!-- start navigation -->
    ...
    <div class="md:w-full lg:w-2/6">
        ...
        <div class="row">
            <div class="column">
            <img class="demo cursor" src="{{ Storage::url($vehicle->images[0]->file_path ?? null)}}" style="width:100%"
            onclick="currentSlide(1)" alt="The Woods">
        </div>
        <div class="column">
        <img class="demo cursor" src="{{ Storage::url($vehicle->images[1]->file_path ?? null)}}" style="width:100%"
        onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
    <img class="demo cursor" src="{{ Storage::url($vehicle->images[2]->file_path ?? null)}}" style="width:100%"
    onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <div class="column">
    <img class="demo cursor" src="{{ Storage::url($vehicle->images[3]->file_path ?? null)}}" style="width:100%"
            ...
            <form method="post" action="{{ route('bookvehicle') }}">
                ...
                <div class="flex items-center justify-center w-full gap-4">
                    <div class="w-full -ml-14 md:ml-0">
                        <input class="w-full border-none rounded-md shadow-md" type="datetime-local" id="pickup_time"
                            name="pickup_time">
                    </div>
                ...
                <div class="flex items-center justify-center gap-4">
                    <div class="w-full -ml-14 md:ml-0">
                        <input class="w-full border-none rounded-md shadow-md" type="datetime-local" name="dropoff_time"
                            id="dropoff_time">
                    </div>
                ...
                <div class="flex items-center justify-center pt-8">
                    <button type="submit"
                        class="w-full bg-[#317256] p-3 rounded text-white font-semibold hover:bg-[#307449]" name="cars"
                        id="cars">
                        Book Now
                    </button>
