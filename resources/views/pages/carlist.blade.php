...
<head> <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body> <!-- start navigation -->
        ...
        <!-- banner section -->
    <div class="flex relative h-[200px] -z-50 md:h-[300px] lg:justify-center">
    ...
    <!-- filtering section -->
        <div class="flex flex-row items-center justify-center -mt-2 md:grid md:grid-flow-row"> <form> <div
            class="flex flex-col md:flex-row border-t-8 border-[#398564] bg-[#D3D3D3] w-full mx-auto">
            <div class="p-0 dropdown md:p-8">
            <label class="font-bold text-[#707070]" for="">Make</label>
            <select class="w-full h-12 mt-2 text-gray-500 border-none rounded-md" name="make" id="cars"
        ...
        <select class="w-full h-12 mt-2 text-gray-500 border-none rounded-md" name="model" id="cars"
            onchange="this.form.submit()">
            ...
            <select class="w-full h-12 mt-2 text-gray-500 border-none rounded-md" name="body_type" id="cars"
                onchange="this.form.submit()">
                ...
                <select class="w-full h-12 mt-2 text-gray-500 border-none rounded-md" name="transmission" id="cars"
                    onchange="this.form.submit()">
    ...
    <!-- car list -->
                    <div class="grid items-center justify-center p-4"> <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div
                            class="bg-[#F8FFF2] grid p-4 rounded-lg shadow-lg transform hover:-translate-y-1 hover:rotate-x-2 hover:shadow-xl transition-transform duration-300">
                            ...
                            <div class="flex w-4/6">
                                ...
                                <div class="flex items-center space-x-1">
                                    ...
                                    @for ($i = 1; $i <= $maxRating; $i++) <svg
                                        class="w-4 h-4 {{ $i <= $rating ? 'text-[#398564]' : 'text-gray-300 dark:text-gray-500' }}"
                        ...
                        <div class="flex items-center justify-center p-4">
                            <a href="{{ route('booknow', ['id' => $vehicle['id']]) }}"
                                class="text-white bg-[#317256] border-0 py-2 px-6 focus:outline-none hover:bg-[#307449] rounded text-lg">Book
                                Now</a>
                        </div>
                    </div>
