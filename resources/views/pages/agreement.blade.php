...
<body>
    ...
    <form method="post" enctype="multipart/form-data" class="max-w-screen-xl flex flex-col gap-4 p-4 mx-auto" id="agreement_form" x-data="getData()">
        ...
        <div x-show="page == 0" class="w-full p-8 border border-gray-300 rounded flex flex-col gap-4 mt-28">
...
21. By signing this you acknowledge that you have received and understood the detailed terms and conditions of the Automobiles Unlimited rental agreement
        ...
        <div x-show="page == 1" class="w-full p-8 border border-gray-300 rounded flex flex-col gap-4 mt-28">
        ...
        <div x-show="page == 2" class="w-full p-8 border border-gray-300 rounded flex flex-col gap-4 mt-28">
        ...
        <div x-show="page == 3" class="w-full p-8 border border-gray-300 rounded flex flex-col gap-8 mt-28">
