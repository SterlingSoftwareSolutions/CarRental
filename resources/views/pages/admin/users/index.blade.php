    ...
    <div class="sm:ml-64 p-6">
        ...
        <div class="grid lg:grid-cols-4 gap-10 ">
            ...
            <div class="grid grid-cols-2 bg-white p-4 rounded-lg ">
                ...
                <div class="flex justify-end">
                    <svg class="w-11 h-11 p-3 rounded-md text-main-green bg-main-green " aria-hidden="true"
        ...
        <div class="mt-10">
                        ...
                        <form class="">
                            <div class="relative">
                                ...
                                <input type="search" id="default-search"
                                    class="border-none w-full p-4 pl-10 text-sm text-gray-500 bg-transparent focus:ring-0"
                                    placeholder="Search">
                            </div>
                        </form>
                    </div>
                                ...
                                <th scope="row" class="px-6 py-4 font-medium text-gray-500 whitespace-nowrap">
                                    <a href="/admin/users/{{ $user['id']}}/">
                                        <div class="flex items-center">
                                            <div class="me-3">
                                                <img src="{{ Storage::url($user->images[0]->file_path) }}"
                                                    class="rounded-full w-10 h-10" alt="Logo Image">
                                            </div>
                                            <div>
            ...
            <div class="w-5/10 mx-auto p-6 m-10 relative shadow-md sm:rounded-lg bg-white  ">
                ...
                <form method="POST"
                    action="{{ isset($user_one) ? route('update_user', ['userid' => $user_one->id]) : route('register') }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name"
                            :value="old('first_name', isset($user_one) ? $user_one->first_name : '')" autofocus
                    ...
                    <div>
                        ...
                        <x-text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name"
                            :value="old('last_name', isset($user_one) ? $user_one->last_name : '')" autofocus
                    ...
                    <div>
                        ...
                        <x-text-input id="mobile" class="block mt-1 w-full" type="text" name="mobile"
                            :value="old('mobile', isset($user_one) ? $user_one->mobile : '')" autofocus
                            autocomplete="mobile" />
                    ...
                    <div>
                        ...
                        <x-text-input id="Address_1" class="block mt-1 w-full" type="text" name="Address_1"
                            :value="old('Address_1', isset($user_one) ? $user_one->Address_1 : '')" autofocus
                    ...
                    <div>
                        ...
                        <x-text-input id="Address_2" class="block mt-1 w-full" type="text" name="Address_2"
                            :value="old('Address_2', isset($user_one) ? $user_one->Address_2 : '')" autofocus
                    ...
                    <div>
                        ...
                        <x-text-input id="city" class="block mt-1 w-full" type="text" name="city"
                            :value="old('city', isset($user_one) ? $user_one->city : '')" autofocus
                            autocomplete="city" />
                    ...
                    <div>
                        ...
                        <x-text-input id="zip" class="block mt-1 w-full" type="text" name="zip"
                            :value="old('zip', isset($user_one) ? $user_one->zip : '')" autofocus autocomplete="zip" />
                    ...
                    <div>
                        ...
                        <x-text-input id="driving_license" class="block mt-1 w-full" type="text" name="driving_license"
                            :value="old('driving_license', isset($user_one) ? $user_one->driving_license : '')"
                            autofocus autocomplete="driving_license" />
                    ...
                    <div>
                        ...
                        <x-text-input id="driving_license_expire_year" class="block mt-1 w-full" type="text"
                            name="driving_license_expire_year"
                            :value="old('driving_license_expire_year', isset($user_one) ? $user_one->driving_license_expire_year : '')"
                            autofocus autocomplete="driving_license_expire_year" />
                    ...
                    <div>
                        ...
                        <x-text-input id="driving_license_expire_month" class="block mt-1 w-full" type="text"
                            name="driving_license_expire_month"
                            :value="old('driving_license_expire_month', isset($user_one) ? $user_one->driving_license_expire_month : '')"
                            autofocus autocomplete="driving_license_expire_month" />
                    ...
                    <div>
                        ...
                        <x-text-input id="driving_license_expire_date" class="block mt-1 w-full" type="text"
                            name="driving_license_expire_date"
                            :value="old('driving_license_expire_date', isset($user_one) ? $user_one->driving_license_expire_date : '')"
                            autofocus autocomplete="driving_license_expire_date" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                            :value="old('email', isset($user_one) ? $user_one->email : '')" autocomplete="username" />
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative rounded-lg border-dashed border-2 border-gray-300 p-6 bg-white">
                            <div
                                class="overflow-hidden bg-cover p-4 bg-white text-center flex flex-col items-center justify-center">
                                <h2 class="mb-2">Preview:</h2>
                                <img id="preview"
                                    class="object-cover min-w-[300px] max-w-[300px] min-h-[200px] max-h-[200px]"
                                    style="display: none;">
                            </div>
                            ...
                            <label for="image" class="cursor-pointer text-center">
                                <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 48 48">
                                    <path
                                        d="M19.406 4L16 7.406l5.297 5.297H8v7.828h5.297L16 25.594 19.406 29l6-6-6-6zm9.188 27.172a6.95 6.95 0 0 0 0-9.84l-2.48-2.48 1.416-1.414 2.478 2.478a4.95 4.95 0 0 1 0 7.007 4.95 4.95 0 0 1-7.008 0l-2.478-2.478-1.414 1.414 2.48 2.48a6.95 6.95 0 0 0 9.838 0z" />
