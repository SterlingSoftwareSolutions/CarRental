                ...
                <form action="/admin/bookings/{{$booking->id}}/review" enctype="multipart/form-data" method="post" id="review_form">
                    ...
                    <div>
                        @if($booking->agreed)
                            ...
                            <p class="mb-4">{{$booking->additional_driver_name}}"</p>
                            <label class="font-bold">Contact Number: </label>
                            <p class="mb-4">{{$booking->additional_driver_mobile}}"</p>
                            <label class="font-bold">Address: </label>
                            <p class="mb-4">{{$booking->additional_driver_address_line_1}}"</p>
                            <p class="mb-4">{{$booking->additional_driver_address_line_2}}"</p>
