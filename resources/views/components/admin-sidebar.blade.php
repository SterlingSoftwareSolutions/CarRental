...
<!-- Side Bar  -->
<aside id="sidebar-multi-level-sidebar" class="fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full drop-shadow-lg top-24 sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-white">
        <ul class="space-y-2 font-medium">
            <!-- Dashboard  -->
            <li>
                <a href="{{ route('dashboard')}}" class="flex items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">
            ...
            <!-- Vehicles  -->
            <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            <svg class="w-5 h-5 transition duration-75 text-gray hover:text-white group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                    ...
                    <a href="{{route('vehicles.all')}}"><span class="flex-1 ml-3 text-left whitespace-nowrap">Vehicles</span></a>
                  <svg class="w-3 h-3 ml-24 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            ...
            <!-- Users  -->
            <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white" aria-controls="dropdown-example2" data-collapse-toggle="dropdown-example2">
            <svg class="w-5 h-5 transition duration-75 text-gray hover:text-white group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                    ...
                    <a href="{{ route('users.index')}}"><span class="flex-1 ml-3 text-left whitespace-nowrap">Users</span></a>
                  <svg class=" ml-[115px] w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                  </svg>
            </button>
            <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                ...
                <li>
                 <a href="/admin/users/create" class="flex items-center w-full p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">Add User</a>
                </li>
                <!-- <li>
                 <a href="#" class="flex items-center w-full p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">Billing</a>
                </li>
            ...
            <!-- Bookings  -->
            <li>
                <a href="{{ route('bookings.all')}}" class="flex items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">
                    <svg fill="currentColor" class="w-5 h-5 transition duration-75 text-gray hover:text-white group-hover:text-white" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 373.678 373.678" xml:space="preserve">
            ...
            <!-- Fines & Tolls  -->
            <li>
                <a href="{{ route('surcharges.all')}}" class="flex items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">
                    <svg fill="currentColor"  class="w-5 h-5 transition duration-75 text-gray hover:text-white group-hover:text-white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                    ...
                    <span class="ml-3">Fines & Tolls</span>
                </a>
            </li>
        </ul>
    </div>
