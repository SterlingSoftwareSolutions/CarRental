...
<!-- Side Bar  -->
<aside id="sidebar-multi-level-sidebar" class="drop-shadow-lg fixed top-24 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <!-- Vehicles  -->
            <li>
            <button type="button" class="flex w-full items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            <svg class=" w-5 h-5 text-gray hover:text-white transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                  ...
                  <svg class=" ml-24 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            ...
            <!-- Users  -->
            <li>
            <button type="button" class="flex w-full items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white" aria-controls="dropdown-example2" data-collapse-toggle="dropdown-example2">
            <svg class="w-5 h-5 text-gray hover:text-white transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
                <a href="{{ route('surcharges.all')}}" class="flex items-center p-2 text-gray-500 rounded-lg text-ma hover:bg-main-green group hover:text-white">
                    <svg fill="currentColor"  class="w-5 h-5 text-gray hover:text-white transition duration-75 group-hover:text-white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
